...
public class ComponentContainers {
    ...
    @SafeVarargs
    public static <T extends AbsoluteLayout> ComponentNode<T> absoluteLayout(final T instance,
    ...
    @SafeVarargs
    public static <T extends Accordion> ComponentNode<T> accordion(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends CssLayout> ComponentNode<T> cssLayout(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends CustomLayout> ComponentNode<T> customLayout(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends FormLayout> ComponentNode<T> formLayout(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends GridLayout> ComponentNode<T> gridLayout(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends HorizontalLayout> ComponentNode<T> horizontalLayout(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends HorizontalSplitPanel> ComponentNode<T> horizontalSplitPanel(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends LoginForm> ComponentNode<T> loginForm(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends Panel> ComponentNode<T> panel(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends TabSheet> ComponentNode<T> tabSheet(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
    ...
    @SafeVarargs
    public static <T extends VerticalLayout> ComponentNode<T> verticalLayout(final T instance,
            final Node<? extends Component>... args) {
        return new ComponentNode(instance, args);
    }
